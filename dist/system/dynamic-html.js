System.register(["aurelia-binding", "aurelia-dependency-injection", "aurelia-logging", "aurelia-task-queue", "aurelia-templating"], function (exports_1, context_1) {
    ...
    var aurelia_binding_1, aurelia_dependency_injection_1, aurelia_logging_1, aurelia_task_queue_1, aurelia_templating_1, logger, DynamicHtml;
    return {
        setters: [
        ...
        execute: function () {
            logger = aurelia_logging_1.getLogger("dynamic-html");
            DynamicHtml = class DynamicHtml {
            ...
            exports_1("DynamicHtml", DynamicHtml);
        }
    };
});
